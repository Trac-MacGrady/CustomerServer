...
import { Dimensions, Image, StyleSheet, TouchableOpacity, View, ViewPagerAndroid, } from 'react-native'
        ...
        if (i == 6 && j == 2) {
          row.push(
            <View key={i}
              ...
              <TouchableOpacity activeOpacity={0.5} onPress={this.props.handlerSendMoji}>
